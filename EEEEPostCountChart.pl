...
my @PHONEMODELS = qw(X3t X3V Xplay Xplay3s Xshot X5L Y22iL Y27 Y13L Y22L X5V Y28L Y23L X5S);# X5MaxL);  # 机型
#my @PHONEMODELS = qw(Xplay Xplay3s Xshot X5MaxL);  # 机型
#my @PHONEMODELS = qw(Xplay Xplay3s Xshot X5MaxL X5MaxLL Y29L);  # 机型
#my @PHONEMODELS = qw(Xplay3s);  # 机型
my $dir = getcwd;
my $workbook;
my $pageNum = 2;	
										...
										foreach $count(2..$colMax-1){
													...
													if($count eq 2){
																...
																if($$eighteenthCol[$count-1] eq 0){
																		...
																		$$twentyFiveCol[$count-1]=$$eighteenthCol[$count]/$$eighteenthCol[$count-1];
																}

																if($$nineteenthCol[$count-1] eq 0){
																		$$twentySixCol[$count-1]=0;
																}else{
																		$$twentySixCol[$count-1]=$$nineteenthCol[$count]/$$nineteenthCol[$count-1];
																}
																
																if($$twentyCol[$count-1] eq 0){
																		$$twentySevenCol[$count-1]=0;
																}else{
																		$$twentySevenCol[$count-1]=$$twentyCol[$count]/$$twentyCol[$count-1];
																}
																
																if($$eighteenthCol[$count-1] eq 0){
																		$$twentyFiveCol[$count]=0;
																}else{
																		$$twentyFiveCol[$count]=$$eighteenthCol[$count+8]/$$eighteenthCol[$count-1];
																}
																
																if($$nineteenthCol[$count-1] eq 0){
																		$$twentySixCol[$count]=0;
																}else{
																		$$twentySixCol[$count]=$$nineteenthCol[$count+8]/$$nineteenthCol[$count-1];
																}
																
																if($$twentyCol[$count-1] eq 0){
																		$$twentySevenCol[$count]=0;
																}else{
																		$$twentySevenCol[$count]=$$twentyCol[$count+8]/$$twentyCol[$count-1];
																}
																
																if($$eighteenthCol[$count-1] eq 0){
																		$$twentyFiveCol[$count+1]=0;
																}else{
																		$$twentyFiveCol[$count+1]=$$eighteenthCol[$count+9]/$$eighteenthCol[$count-1];
																}
																
																if($$nineteenthCol[$count-1] eq 0){
																		$$twentySixCol[$count+1]=0;
																}else{
																		$$twentySixCol[$count+1]=$$nineteenthCol[$count+9]/$$nineteenthCol[$count-1];
																}
																...
																if($$twentyCol[$count-1] eq 0){
																		...
																		$$twentySevenCol[$count+1]=$$twentyCol[$count+9]/$$twentyCol[$count-1];
																}
													...
													if($$sixthCol[$count-1] eq 0){
															...
															$$eleventhCol[$count-1]=${$senToFour[0]}[$count-1]/$$sixthCol[$count-1];
													}
													
													if($$seventhCol[$count-1] eq 0){
															$$twelvethCol[$count-1]=0;
													}else{
															$$twelvethCol[$count-1]=${$senToFour[1]}[$count-1]/$$seventhCol[$count-1];
													}
													
													if($$eightthCol[$count-1] eq 0){
															$$thirteennCol[$count-1]=0;
													}else{
															$$thirteennCol[$count-1]=${$senToFour[2]}[$count-1]/$$eightthCol[$count-1];
													}
...
sub calculateRomRate{
	...
	for (my $index = 1; $index <= $colMax; $index++){
		$$row30[$index] = $$row2[$index] / $romcount_1;
		$$row31[$index] = $$row3[$index] / $romcount_2;
		$$row32[$index] = $$row4[$index] / $romcount_3;
	}
	$$dataArr[28] = $row30;
	$$dataArr[29] = $row31;
	$$dataArr[30] = $row32;
